...
const SECTIONS: RouteSection[] = [
  ...
  },
  {
    ...
    routes: [
      ...
      { label: "Share & earn", original: "/app/affiliate", preview: "/admin/full-app/customer/affiliate", note: "Customer affiliate acquisition and reward surface." },
  ...
  },
  {
    ...
    routes: [
      ...
      { label: "Share Cleanr & earn", original: "/csp/dashboard/affiliate", preview: "/admin/full-app/csp/affiliate", note: "CSP affiliate growth for genuinely new Cleanr households." },
      { label: "Existing clients", original: "/csp/dashboard/existing-clients", preview: "/admin/full-app/csp/existing-clients", note: "Relationship provenance for households the CSP already served before Cleanr." },
